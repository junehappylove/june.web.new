...
public class FreemarkerUtil {
	...
	public static void creteHtml(String ftl, String htmlName, Map<String, Object> map, String realPath,HttpServletRequest httpServletRequest,HttpServletResponse httpServletResponse) throws TemplateException
	{
     ...
     * @return
     */
    public static String printString(String templatePaht,Map<String,Object> root,HttpServletRequest httpServletRequest) {
    	Configuration config=new Configuration(); 
