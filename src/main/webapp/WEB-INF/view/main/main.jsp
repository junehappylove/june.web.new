...
<script type="text/javascript" src="${ctx}/js/login/main.js"></script>
<script type="text/javascript" src="${ctx}/js/socket/chat.js"></script>
</head>
	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="side-menu">
				<li class="nav-header">
					<div class="dropdown profile-element"><!-- 默认调用 /upload/profile_small.jpg -->
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			<div class="row border-bottom">
				...
				<ul class="nav navbar-top-links navbar-right">
							...
							<li class="m-t-xs">
								<div class="dropdown-messages-box">
									...
									<div class="media-body">
										...
										<strong>小四</strong>
										这个在日本投降书上签字的军官，建国后一定是个不小的干部吧？ <br> 
							...
							<li>
								<div class="dropdown-messages-box">
									...
									<div class="media-body ">
										...
										<strong>国民岳父</strong>
										如何看待"男子不满自己爱犬被称为狗，刺伤路人"?——这人比犬还凶 <br> 
					...
					<li class="dropdown hidden-xs"><!-- 主题 -->
			...
			<div class="row content-tabs">
				...
				<a href="${ctx}/logout" class="roll-nav roll-right J_tabExit">
			...
			<div class="footer">
				<div class="pull-right"> 
					&copy; 2016-2025 <a href="http://www.zi-han.net/" target="_blank">zihan's blog</a>
				</div>
			</div>
		</div>
		<!--右侧部分结束-->
						...
						<ul class="sidebar-list">
							...
							<li>
								<a href="#"> 
									...
									<div class="small">已完成： 22%</div>
									<div class="small text-muted m-t-xs">项目截止： 4:00 - 2016.12.01</div>
								</a>
							</li>
						</ul>
					</div>
		...
		<!--右侧边栏结束-->
		<!-- mini聊天窗口开始 --><!-- WebSocket实现 -->
		<div class="small-chat-box fadeInRight animated">
			<div class="heading" draggable="true">
				<small class="chat-date pull-right"><span id='nowdate'></span></small> 智能问答/聊天
				<span class="badge badge-info pull-left" id=""><i class="fa fa-comments"></i></span>
			</div>
