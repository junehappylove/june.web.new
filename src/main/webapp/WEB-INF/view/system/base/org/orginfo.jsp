					...
					<div class="example">
						<form id="searchForm" method="post" class="form-horizontal">
							<div class="form-group">
								...
								<c:if test="${orginfo_search eq 'hasAuthority'}">
						...
						<div class="col-md-12">
							<div id="toolbar" class="btn-group">
								<c:if test="${orginfo_btnAdd eq 'hasAuthority'}">
									<button id="btn_add" type="button"
										class="btn btn-outline btn-default" onclick="addNew()">
										<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
									</button>
								</c:if>
								<c:if test="${orginfo_btnEdit eq 'hasAuthority'}">
								...
								<c:if test="${orginfo_btnDelete eq 'hasAuthority'}">
			...
			<div class="modal-content">
				...
				<form id="modalForm">
					...
					<div class="modal-footer">
						<c:if
							test="${orginfo_btnAddSave eq 'hasAuthority' || orginfo_btnEditSave eq 'hasAuthority'}">
