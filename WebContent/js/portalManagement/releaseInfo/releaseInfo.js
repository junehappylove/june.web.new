...
//		doAjax("post",contextPath + "/PortalManagement/ReleaseInfo/saveContent",data,"savesuccess",null,false);
//	}
}
...
function submitInfo()
{
		...
		doAjax("post",contextPath + "/PortalManagement/ReleaseInfo/submitContent",data,"submitsuccess",null,false);
...
function showConfirmbebeforeSubmit()
{
	if(check())
	{
		showConfirm("submitInfo",getMessageFromList("SubmitContent",null),null,null,contextPath + "/PortalManagement/ReleaseInfo/submitContent",submitsuccess,false);
	}
