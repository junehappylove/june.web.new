...
function searchMyInfo()
{
	...
	commonGetrowdatas("MyInfoGrid",getSearchData(),contextPath + "/PortalManagement/MyInfo/search","commonCallback",true);
}
...
function submitRow(contentId)
{
	...
	doAjax("post",contextPath + "/PortalManagement/MyInfo/submitRow",data,"submitRowSuccess",null,false);
}
...
function editRow(contentId)
{
		top.$('#myDialog').dialog({
		    ...
		    closed: false,
		    cache: false,
		    href: contextPath + "/PortalManagement/MyInfo/editRow?contentId=" + contentId,
		    modal: true
		});
}
...
function deleteRow(contentId)
{
	...
	doAjax("post",contextPath + "/PortalManagement/MyInfo/deleteRow",data,"submitRowSuccess",null,false);
}
...
function checkRow(contentId)
{
	top.$('#myDialog').dialog({
	    ...
	    closed: false,
	    cache: false,
	    href: contextPath + "/PortalManagement/MyInfo/checkRow?contentId=" + contentId,
	    modal: true
	});
}
//批量提交资讯
function batchSubmit()
{
	...
	if(selectRows>0)
	{
		...
		if(contentId!="")
		{
			...
			doAjax("post",contextPath + "/PortalManagement/MyInfo/batchSubmit",data,"submitRowSuccess",null,false);
		}else{
...
function batchDel()
{
	...
	if(selectRows>0)
	{
		...
		if(contentId!="")
		{
			...
			doAjax("post",contextPath + "/PortalManagement/MyInfo/batchDel",data,"submitRowSuccess",null,false);
		}else{
			showOnlyMessage("error",getMessageFromList("SelectSubmitRow",null))
		}
