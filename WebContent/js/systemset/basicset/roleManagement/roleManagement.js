	...
	$(function() {
		...
		.bootstrapTable(
				...
				$('#modalForm').bootstrapValidator(
						...
						{
							//编辑保存
							doAjax("post",contextPath + "/SystemSet/BasicSet/RoleManagement/saveEditRole",$form.serialize(),saveSuccess);
						}
						else if($("#isNew").val() == 1)
						{
							//新增保存
							doAjax("post",contextPath + "/SystemSet/BasicSet/RoleManagement/saveAddRole",$form.serialize(),saveSuccess);
						}
...
function searchRoleInfo()
{
	...
	+ "/SystemSet/BasicSet/RoleManagement/getRoleInfo", "commonCallback", true)
}
...
function checkDetail(roleId) {
	...
	doAjax("post",contextPath + "/SystemSet/BasicSet/RoleManagement/checkDetail",data,checkDetailSuccess)
}
...
function deleteRow() {
	...
	if (rowCount > 0) {
		...
		showConfirm(sureDelete, "是否要删除选中的行？", "post", contextPath
				+ "/SystemSet/BasicSet/RoleManagement/delRole", data, searchRoleInfo);
	} else {
...
function loadMenuTree(roleId){
	doAjax("post",contextPath+"/SystemSet/BasicSet/RoleManagement/initMenuTree",{roleId:roleId},menuTreeCallback);
}
...
function assignMenu()
{
	...
	doAjax("post",contextPath + "/SystemSet/BasicSet/RoleManagement/authorityMenus",data,authorityMenuSuccess)
}
...
{
	doAjax("post",contextPath+"/SystemSet/BasicSet/RoleManagement/initUserTree",{roleId:roleId},userTreeCallback);
}
...
function assignUser()
{
	...
	doAjax("post",contextPath + "/SystemSet/BasicSet/RoleManagement/assginUsers",data,authorityUserSuccess)
}
