...
<script type="text/javascript"
	src="${ctx}/js/portalManagement/myInfo/myInfo.js"></script>
</head>
	...
	<div class="formbody">
		...
		<div class="tabson">
			...
			<div id="search">
				...
				<li><label>资讯状态</label>
	        	<select:select name="infoStatusType" id="status" type="easyui-combobox" style="width:100px;height:32px;" dataoptions="editable:false" defaultValue="true"/>
	       		 </li>

					<li><label>&nbsp;</label><input id="search" type="button"
						class="scbtn" value="查询" onclick="searchMyInfo()" /></li>
				</ul>
				<ul class="toolbar_r">
					<li class="click" ><span title="批量提交资讯"><img
							src="${ctx}/images/batchpass.png"
							onclick="batchSubmit()" /></span></li>
					<li class="click" ><span title="批量删除资讯"><img
							src="${ctx}/images/batchback.png"
							onclick="batchDel()" /></span></li>
				</ul>
				</form>
			</div>

			<div class='myGrid'>
				<div id="MyInfoGrid"></div>
			</div>
		</div>
	</div>
