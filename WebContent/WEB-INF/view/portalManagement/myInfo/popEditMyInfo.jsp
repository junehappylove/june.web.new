...
function saveInfo()
{
	if(check())
	{
		...
		doAjax("post",contextPath + "/PortalManagement/MyInfo/saveContent",data,"savesuccess",null,false);
	}
}
...
function submitInfo()
{
	...
	doAjax("post",contextPath + "/PortalManagement/MyInfo/submitContent",data,"submitsuccess",null,false);
}
