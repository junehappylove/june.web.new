...
<script type="text/javascript" src="${ctx}/js/systemset/basicset/roleManagement/roleManagement.js"></script>
</head>
<body>
                    ...
                    <div class="col-sm-12">
						...
						<div class="col-md-12">
							...
							<c:if test="${rolemanagement_btnAdd eq 'hasAuthority'}">
								...
								<c:if test="${rolemanagement_btnEdit eq 'hasAuthority'}">
								...
								<c:if test="${rolemanagement_btnDelete eq 'hasAuthority'}">
								<button id="btn_delete" type="button" class="btn btn-outline btn-default"
									onclick="deleteRow()">
									<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>删除
								</button>
								</c:if>
								<c:if test="${rolemanagement_btnAssignUser eq 'hasAuthority'}">
								...
								<c:if test="${rolemanagement_btnAssignMenu eq 'hasAuthority'}">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<input type="hidden" name="roleId" class="form-control" id="roleId">
					...
					<c:if test="${rolemanagement_saveAssignUser eq 'hasAuthority' || rolemanagement_saveAssignMenu eq 'hasAuthority'}">
	...
	<div class="modal fade" id="menuModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog" style="height: 1000px;">
			<div class="modal-content">
				...
				<div class="modal-footer">
				<c:if test="${rolemanagement_saveAssignMenu eq 'hasAuthority'}">
					<button type="button" class="btn btn-primary"
	...
	<div class="modal fade" id="userModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog" style="height: 1000px;">
			<div class="modal-content">
				...
				<div class="modal-footer">
				<c:if test="${rolemanagement_saveAssignUser eq 'hasAuthority'}">
					<button type="button" class="btn btn-primary"
